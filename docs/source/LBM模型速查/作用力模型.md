...
文档B站视频讲解：
> [LBM中的作用力模型](https://www.bilibili.com/video/BV1iXBEBVE6N/)
...
### 1.3. Exact Difference Method (EDM)
...
## 代码下载
[单松弛作用力模型.zip](https://raw.githubusercontent.com/JR-LBM-THU/JRLBM-tutorial/main/docs/source/LBM基础入门/files/单松弛作用力模型.zip)
