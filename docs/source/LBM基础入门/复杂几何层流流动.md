...
其中，
$${\color[RGB]{240, 0, 0} F_{\alpha}=\delta _t\omega _i\left( 1-\frac{1}{2\tau} \right) \left[ \frac{\boldsymbol{e}_i-\boldsymbol{u}}{c_{s}^{2}}+\frac{(\boldsymbol{e}_i\cdot \boldsymbol{u})\boldsymbol{e}_i}{c_{s}^{4}} \right] \cdot \boldsymbol{F}}$$
