...
后续我们会整理LBM里所有常见的作用力模型，这里先讲最常用的一种——Guo作用力格式[Z. Guo, C. Zheng, B. Shi, Discrete lattice effects on the forcing term in the lattice Boltzmann method, Phys. Rev. E. 65(4) (2002) 046308.](https://doi.org/10.1103/PhysRevE.65.046308)。这种格式的使用很简单，只需要在LBM的演化方程里加一个源项就行：
